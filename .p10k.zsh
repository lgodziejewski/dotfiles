# Generated by Powerlevel10k configuration wizard on 2020-04-13 at 21:22 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|awless|terraform|pulumi|kubectl|kubens|kubectx|sam'
